namespace Tikhe_POS
{
    partial class ReportMain
    {
        ...
        private void InitializeComponent()
        {
			...
			this.order_graphic.Size = new System.Drawing.Size(134, 24);
			this.order_graphic.TabIndex = 5;
			this.order_graphic.TabStop = true;
			this.order_graphic.Text = "Branch Sales";
			...
			this.customer_graphic.Size = new System.Drawing.Size(136, 24);
			this.customer_graphic.TabIndex = 5;
			this.customer_graphic.TabStop = true;
			this.customer_graphic.Text = "Service Sales";
